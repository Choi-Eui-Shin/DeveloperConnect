...
import com.rs.DriverService.ContextFeature;
import com.rs.DriverService.DriverBehaviorDetail;
import com.rs.InputData.CarProbe;
...
public class MapView extends PApplet {
	...
	private static final String CONFIG_FILE = "res/mapview.json";
	private static final String INPUT_FILE = "res/CarProbeSample.json";
	...
	private void traceTrip() {
	    ...
	    tripMarker.setColor(color(255, 0, 0, 255));
	 ...
	 * @return
	 */
	public List<DriverBehaviorDetail> prepare(String inputFile, String jobId)
	{
		Configuration config = null;
		try {
			config = new Configuration(CONFIG_FILE);
			
			InputData inputData = new InputData("res/" + inputFile);
	 ...
	 * @param args
	 * 
	 * --job_id 723ee28a-9821-4577-bdab-a9a8c52f173b
	 * 
	 * 
	 */
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(driverBehaviorDetails);
